<img src="docs/lychee-logo.svg" alt="Lychee" width="96">
...
- Sumner ([@sumnerkirby](https://github.com/sumnerkirby))
- Mei ([@Mei-Morrow](https://github.com/Mei-Morrow))
- Jake ([@jakeryderv](https://github.com/jakeryderv))
...
Week 1: project charter and repository setup. See [`docs/PROJECT_CHARTER.md`](docs/PROJECT_CHARTER.md) for the full charter.
